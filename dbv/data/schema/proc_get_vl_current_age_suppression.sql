...
BEGIN
  SET @QUERY =    "SELECT
                    ...
                    (SUM(`noage_suppressed`) + SUM(`noage_nonsuppressed`)) AS `noage`,
                    (SUM(`less2_suppressed`) + SUM(`less2_nonsuppressed`)) AS `less2`,
                    (SUM(`less9_suppressed`) + SUM(`less9_nonsuppressed`)) AS `less9`,
                    (SUM(`less14_suppressed`) + SUM(`less14_nonsuppressed`)) AS `less14`,
                    (SUM(`less19_suppressed`) + SUM(`less19_nonsuppressed`)) AS `less19`,
                    (SUM(`less24_suppressed`) + SUM(`less24_nonsuppressed`)) AS `less24`,
                    (SUM(`over25_suppressed`) + SUM(`over25_nonsuppressed`)) AS `over25`
