DROP PROCEDURE IF EXISTS `proc_get_vl_current_gender_suppression_listing_partner_year`;
DELIMITER //
CREATE PROCEDURE `proc_get_vl_current_gender_suppression_listing_partner_year`
