...
class Subcounties extends MY_Controller
{
	...
	{
		$data['outcomes']= $this->subcounty_model->subcounty_outcomes($year,$month,$to_month);
	...
	{
		$data['outcomes']= $this->subcounty_model->subcounty_vl_outcomes($year,$month,$subcounty,$to_month);
	...
	{
		$data['outcomes'] = $this->subcounty_model->subcounty_gender($year,$month,$subcounty,$to_month);
	...
	{
		$data['outcomes'] = $this->subcounty_model->subcounty_age($year,$month,$subcounty,$to_month);
	...
	{
		$data['outcomes'] = $this->subcounty_model->subcounty_sites($year,$month,$subcounty,$to_month);
		
    	$link = $year . '/' . $month . '/' . $subcounty . '/' . $to_month;
	...
	{
		$this->subcounty_model->download_subcounty_sites($year,$month,$subcounty,$to_month);
	}
